...
<body>
	...
	<div class="page">
		<header>
			...
			<div id="login">
				<a href="log_in.html">Log in</a><BR><a href="">Sign up</a>
			</div>
			<form id="search">
			...
			<form class="sign_up" method="post" action="forum/register.php" onSubmit="return validate(this);" name="form">
				<div class="text_boxes">
					...
					<div>
						...
						<input type="password" name="password_confirm" name="confirm_password" id="confirm_password" maxlength = "20">
					</div>
				...
				<div>
					...
					<input type="text" name="dateOfBirth" id="dateOfBirth" placeholder="yyyy-mm-dd" maxlength = "10">
				</div>
				<span id = "valid_dob"> Please enter a valid birth date</span>
				<div>
					<input id="terms_agree" type="checkbox" name="terms_agree">
					<label id="terms_label" for="terms_agree">Agree to Terms and Conditions<span id="invalid_tos">*</span></label>
				</div>
